...
def get_offers():
    ...
    for item in tab_categories:
        if "tab_content" in item["id"]:
            ...
            for name,link,disc_pct,disc_price,ori_price,icon in zip(tab_item_names,tab_item_links,tab_item_disc_pct,tab_item_disc_price,tab_item_ori_price,tab_item_icon):
                ...
                if "TopSellers" in item["id"]:
                    ...
                    game_details["top-sellers"]["discount_price"].append(disc_price.text)
                ...
                if "ConcurrentUsers" in item["id"]:
                    ...
                    game_details["most-popular"]["discount_price"].append(disc_price.text)
                    game_details["most-popular"]["original_price"].append(ori_price.text)
                ...
                if "ComingSoon" in item["id"]:
                    ...
                    game_details["coming-soon"]["discount_price"].append(disc_price.text)
